...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <li><?php  echo anchor('controller_Pemesanan/daftarpembelian', 'Daftar Pembelian');?></li>
        
        <li>
			<?php if($this->session->userdata('username') && ($this->session->userdata('group'))) { ?>
      
			
      <?=anchor('Controller_Barang/showcart','<span class="glyphicon glyphicon-shopping-cart" aria-hidden="true" ></span>' )?>
    <?php } ?>
		</li>

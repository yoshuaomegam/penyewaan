...
<h1 >Products Table</h1>
    ...
    <tbody>
        ...
        <tr>
            ...
            <th><?php echo $barang->notelp;?></th>
            <td><?php echo $barang->nama_kurir ?></td>
            <td><?php echo $barang->status ?></td>

            <td><?php echo '<a class="btn btn-primary btn-sm" href="'.base_url().'/controller_pemesanan/barang_kurir/'.$barang->username.'">Lihat Barang</a>'?>
              <?php echo '<a class="btn btn-primary btn-sm" href="'.base_url().'/controller_Pemesanan/validasi_pengembalian/'.$barang->id_user.'">Validasi Pengembalian</a>'?>
            </td>
